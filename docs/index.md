---
title: 欢迎使用 Abaqus 中文文档
description: Abaqus 软件官方用户指南中文版
---
...
- :material-check-circle: **完整中文翻译** - 保留技术术语英文原名
- :material-check-circle: **暗色/亮色模式** - 切换按钮在右上角
- :material-check-circle: **强大搜索功能** - 支持全文搜索和高亮
- :material-check-circle: **代码块高亮** - 支持复制和语法高亮
- :material-check-circle: **版本控制** - 文档版本追踪
...
欢迎参与文档改进！请访问我们的 [GitHub 仓库](https://github.com/example/guide-of-abaqus) 提交 Issue 或 Pull Request。

---

*本文档由社区志愿者翻译整理，如发现错误欢迎指正。*
